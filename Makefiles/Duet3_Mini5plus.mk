# Makefile for the Duet3_Mini5plus bootloader configuration
# CAN in-application programmer for the Duet 3 Mini 5+ main board

# Board name
BOARD := Duet3_Mini5plus
...
# Linker script
LINKER_SCRIPT := $(CURDIR)/src/Hardware/SAME51/same54p20a_iap_ram.ld
