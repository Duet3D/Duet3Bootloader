# Makefile for the SAME5x bootloader configuration
# Bootloader for SAME5x expansion and tool boards

# Board name
BOARD := SAME5x

# Output binary name
BINARY := Duet3Bootloader-SAME5x
...
# Linker script
LINKER_SCRIPT := $(CURDIR)/src/Hardware/SAME51/same51n19a_flash.ld
