# Makefile for the Duet3_MB6HC bootloader configuration
# CAN in-application programmer for the Duet 3 MB6HC main board

# Board name
BOARD := Duet3_MB6HC

# Output binary name
BINARY := Duet3_CANiap32_MB6HC
...
C_DEFINES := -D__SAME70Q20B__ -DMB6HC -DCAN_IAP -Dnoexcept=
CXX_DEFINES := -D__SAME70Q20B__ -DMB6HC -DCAN_IAP
