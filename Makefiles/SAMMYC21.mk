# Makefile for the SAMMYC21 bootloader configuration
# Bootloader for the Sammy C21 board

# Board name
BOARD := SAMMYC21

# Output binary name
BINARY := Duet3Bootloader-SAMMYC21
...
C_DEFINES := -D__SAMC21G18A__ -DSAMMYC21 -Dnoexcept=
CXX_DEFINES := -D__SAMC21G18A__ -DSAMMYC21
