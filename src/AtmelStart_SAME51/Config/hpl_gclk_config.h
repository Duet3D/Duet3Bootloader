 ...
 * GCLK1 is fed from DPLL0, divisor 2, frequency 60MHz. It is used to clock CAN (max 100MHz), SERCOM (max 100MHz), ADC (max 100MHz), TCC, and TC devices (some TCs are max 100MHz)
 */
